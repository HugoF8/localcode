...
-- CreateEnum
CREATE TYPE "estado_post" AS ENUM ('ativo', 'inativo');
...
CREATE TABLE "post" (
    ...
    "estado_post" "estado_post" NOT NULL,
...
CREATE TABLE "ticket" (
    ...
    "estado_ticket" "estado_ticket" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "pagina_freguesia" ADD CONSTRAINT "pagina_freguesia_id_morada_fkey" FOREIGN KEY ("id_morada") REFERENCES "morada"("id_morada") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "pedido_pagina" ADD CONSTRAINT "pedido_pagina_id_morada_fkey" FOREIGN KEY ("id_morada") REFERENCES "morada"("id_morada") ON DELETE SET NULL ON UPDATE NO ACTION;
