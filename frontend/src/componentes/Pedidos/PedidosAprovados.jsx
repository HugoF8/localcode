...
function DropdownAprovados({ idUtilizador }) {
  ...
  useEffect(() => {
    const fetchPedidos = async () => {
      ...
      try {
        ...
        const response = await fetch(`http://localhost:3000/api/pedidosPagina/PedidosAprovados`, {
          method: 'GET',
          headers: {
...
export default DropdownAprovados